...
function core:CreateCastbar(self)
  ...
  elseif(self.mystyle == "target") then
    ...
    castbar:SetWidth(cfg.units.target.castbar.width - cfg.units.target.castbar.height - 2)
    castbar:SetHeight(cfg.units.target.castbar.height)
    castbar:SetPoint("BOTTOMRIGHT", self, "TOPRIGHT", 0, cfg.frames.secondary.height + cfg.frames.secondary.margin * 2)
