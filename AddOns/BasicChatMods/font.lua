...
BCM.modules[#BCM.modules+1] = function()
	...
	BCM.chatFuncsPerFrame[#BCM.chatFuncsPerFrame+1] = function(n)
		...
		cF:SetFont(bcmDB.fontname or name, bcmDB.fontsize or size, bcmDB.fontflag or fontflag)
		cFE:SetFont(bcmDB.fontname or name, bcmDB.fontsize or size, bcmDB.fontflag or fontflag)
	end
end
